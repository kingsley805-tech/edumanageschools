-- Run this in Supabase Dashboard → SQL Editor (fixes signup "not found" for new numbers).
-- Full migration: supabase/migrations/20260529120000_validate_registration_number_rpc.sql
