...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/20 border-b border-white/10 supports-[backdrop-filter]:bg-background/10 shadow-lg shadow-black/10">
        <div className="container flex h-14 md:h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex gap-2 md:gap-3">
            <Button variant="outline" onClick={() => navigate("/auth")} className="border-2 hover:border-primary/50 transition-all duration-200 text-xs md:text-sm px-3 md:px-4">
              Sign In
            </Button>
      ...
      <section className="relative py-12 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="container relative px-4 md:px-6">
          <div className="grid gap-8 md:gap-16 lg:grid-cols-2 items-center">
            <div className="space-y-6 md:space-y-8 animate-fade-up relative z-10 text-center lg:text-left">
              <div className="inline-block rounded-full backdrop-blur-xl bg-white/10 px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm font-medium text-white border border-white/20 shadow-lg shadow-blue-500/20">
                <span className="relative flex items-center gap-2 justify-center lg:justify-start">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                  </span>
                  <span className="hidden sm:inline">Trusted by 500+ Schools Worldwide</span>
                  <span className="sm:hidden">500+ Schools</span>
                </span>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-xl mx-auto lg:mx-0 leading-relaxed drop-shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                <Button size="lg" onClick={() => navigate("/auth")} className="relative bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-base md:text-lg px-6 md:px-8 hover:shadow-2xl hover:shadow-cyan-500/50 hover:scale-105 transition-all duration-200 group overflow-hidden w-full sm:w-auto">
                ...
                <Button size="lg" variant="outline" className="text-base md:text-lg px-6 md:px-8 border-2 border-white/30 text-white backdrop-blur-xl bg-white/10 hover:bg-white/20 hover:border-white/50 hover:shadow-lg hover:shadow-white/20 transition-all duration-200 w-full sm:w-auto" onClick={() => navigate("/auth")}>
                  Sign In to Portal
                </Button>
              </div>

              {/* Stats */}
              <div className="grid grid-cols-3 gap-3 md:gap-6 lg:gap-8 pt-6 md:pt-8">
                {[{
                number: "500+",
                label: "Schools"
              }, {
                ...
                number: "99.9%",
                label: "Reliability"
              }].map((stat, index) => <div key={index} className="text-center backdrop-blur-xl bg-white/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/20 shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300 hover:scale-105">
                    <div className="text-xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-1 md:mb-2 drop-shadow-lg">{stat.number}</div>
            ...
            <div className="relative animate-scale-in order-first lg:order-last">
              ...
              <div className="absolute -inset-4 md:-inset-8 rounded-2xl md:rounded-3xl bg-gradient-to-r from-cyan-500/40 via-blue-500/40 to-purple-500/40 blur-2xl md:blur-3xl opacity-60 animate-pulse"></div>
              <div className="absolute -inset-2 md:-inset-4 rounded-2xl md:rounded-3xl bg-gradient-to-r from-cyan-400/20 to-purple-400/20 blur-xl"></div>
              <div className="relative rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-white/20 backdrop-blur-xl bg-white/5">
      ...
      <section className="py-12 md:py-20 relative">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-white drop-shadow-lg px-4">
          ...
          <div className="grid gap-4 md:gap-6 lg:gap-8 md:grid-cols-3">
            {benefits.map((benefit, index) => <div key={index} className="text-center p-6 md:p-8 backdrop-blur-xl bg-white/10 rounded-xl md:rounded-2xl border border-white/20 shadow-lg shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300 hover:scale-105 animate-fade-in group" style={{
            animationDelay: `${index * 0.2}s`
          }}>
                <div className="inline-flex p-3 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 mb-4 md:mb-6 group-hover:from-cyan-500/30 group-hover:to-blue-500/30 transition-all duration-300 shadow-lg shadow-cyan-500/20">
                  <benefit.icon className="h-6 w-6 md:h-8 md:w-8 text-cyan-300" />
                </div>
      ...
      <section className="py-12 md:py-20 relative">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-white drop-shadow-lg px-4">
              Everything You Need
          ...
          <div className="grid gap-4 md:gap-6 lg:gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => <div key={index} className="group relative backdrop-blur-xl bg-white/10 rounded-xl md:rounded-2xl p-6 md:p-8 border border-white/20 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:scale-105 animate-fade-in overflow-hidden" style={{
            animationDelay: `${index * 0.1}s`
          }}>
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} rounded-xl md:rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl`}></div>
                <div className={`absolute -inset-1 bg-gradient-to-br ${feature.gradient} rounded-xl md:rounded-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 blur-sm`}></div>
                <div className="relative z-10">
                  <div className={`inline-flex p-2.5 md:p-3 rounded-lg md:rounded-xl bg-gradient-to-br ${feature.gradient} mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-xl`}>
                    <feature.icon className="h-5 w-5 md:h-6 md:w-6 text-white" />
                  </div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2 md:mb-3 text-white group-hover:text-cyan-300 transition-colors">
                    {feature.title}
                  </h3>
      ...
      <section className="py-12 md:py-20 lg:py-24 relative">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-cyan-600 via-blue-600 to-purple-600 p-6 md:p-12 lg:p-16 text-center shadow-2xl border border-white/20 backdrop-blur-xl">
            {/* Glowing effect */}
            <div className="absolute -inset-1 bg-gradient-to-br from-cyan-400 via-blue-400 to-purple-400 rounded-2xl md:rounded-3xl blur-xl opacity-50 animate-pulse"></div>
            ...
            <div className="relative z-10 space-y-6 md:space-y-8">
              <div className="space-y-3 md:space-y-4">
                ...
                <p className="text-base md:text-lg lg:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed px-2">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                <Button size="lg" className="bg-white text-blue-600 hover:bg-white/90 text-base md:text-lg px-6 md:px-8 py-5 md:py-6 hover:scale-105 transition-all duration-200 font-semibold shadow-xl hover:shadow-2xl hover:shadow-white/20 w-full sm:w-auto" onClick={() => navigate("/auth")}>
                  Create Your Account
                </Button>
                <Button size="lg" variant="outline" onClick={() => navigate("/auth")} className="border-2 border-white/50 text-white backdrop-blur-xl bg-white/10 hover:bg-white/20 text-base md:text-lg px-6 md:px-8 py-5 md:py-6 hover:scale-105 transition-all duration-200 font-semibold w-full sm:w-auto">
                  Sign In to Portal
                </Button>
              </div>
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/10 py-8 md:py-12 backdrop-blur-xl bg-black/20">
