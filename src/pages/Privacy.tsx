          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 shadow-2xl shadow-blue-500/20">
            ...
            <div className="space-y-6 md:space-y-8 text-white/90 prose prose-invert max-w-none prose-sm md:prose-base">
              <section className="animate-fade-in" style={{ animationDelay: '0.1s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">1. Information We Collect</h2>
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">2. How We Use Your Information</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed mb-3 md:mb-4">
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.3s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">3. Data Security</h2>
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">4. Data Sharing</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed mb-3 md:mb-4">
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.5s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">5. Your Rights</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed mb-3 md:mb-4">
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">6. Children's Privacy</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed">
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">7. Changes to This Policy</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed">
              ...
              <section className="animate-fade-in" style={{ animationDelay: '0.8s' }}>
                <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-cyan-300">8. Contact Us</h2>
                <p className="text-sm md:text-base text-white/80 leading-relaxed break-words">
                  If you have any questions about this Privacy Policy, please contact us at{" "}
                  <a href="mailto:animanthony7@gmail.com" className="text-cyan-300 hover:text-cyan-200 underline break-all">
